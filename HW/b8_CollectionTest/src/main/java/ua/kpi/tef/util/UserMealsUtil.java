...
//        .toLocalTime();
    ...
    public static List<UserMealWithExceed>  getFilteredWithExceeded(List<UserMeal> mealList, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
        ...
        Map<LocalDate, Integer> caloriesPerAllDay = mealList.stream().collect(
                groupingBy(meal -> meal.getDateTime().toLocalDate(), summingInt(meal -> meal.getCalories())));

        List<UserMealWithExceed> userMealsWithExceed = mealList.stream()
                ...
                .map(m -> new UserMealWithExceed(m.getDateTime(), m.getDescription(), m.getCalories(),
                        caloriesPerAllDay.get(m.getDateTime().toLocalDate()) > caloriesPerDay))
